...
// CODE HERE
let totalAcres = 0; //create new variable totalAcres
for(let i = 0; i < fujiAcres.length; i++){ //as we know that all 3 arrays are the same length, we can use length of any fujiAcres/galaAcres/pinkAcres 
    totalAcres += (fujiAcres[i] + galaAcres[i] + pinkAcres[i]); // increments totalAcres by the sum of fujiAcres, galaAcres, pinkAcres in a day of week i
console.log(`Total acres: ${totalAcres}`); //prints to consol totalAcres value
}
...
// CODE HERE
let averageDailyAcres = totalAcres / 7; //calculates avarage number of acres picked per day 
console.log(`Average daily acres: ${averageDailyAcres}`); //prints to console es avarage number of acres
...
// CODE HERE
while(acresLeft > 0){ //this while loop traverses acres left and increments days that needed to finish the work
    days++;
    acresLeft -= averageDailyAcres;
}
console.log(`Days: ${days}`); //prints number of days to console 
...
for(let i = 0; i < fujiAcres.length; i++){ //as we know that all 3 arrays are the same length, we can use length of any fujiAcres/galaAcres/pinkAcres
    fujiTons.push(fujiAcres[i] * 6.5); //adds number how many tons of fuji apples picked on each day
    galaTons.push(galaAcres[i] * 6.5); //adds number how many tons of gala apples picked on each day
    pinkTons.push(pinkAcres[i] * 6.5); //adds number how many tons of pink apples picked on each day
}

console.log(`Daily amount of apples picked, in tons: \n` 
+ `    Fuji: ${fujiTons} \n    Gala: ${galaTons} \n    Pink: ${pinkTons}`); //prints each array to console 
...
for (let i = 0; i < fujiTons.length; i++) { //as we know that all 3 arrays are the same length, we can use length of any fujiAcres/galaAcres/pinkAcres
    fujiPounds += fujiTons[i] * 2000; //calculates total number of pounds for fuji
    galaPounds += galaTons[i] * 2000; //calculates total number of pounds for gala
    pinkPounds += pinkTons[i] * 2000; //calculates total number of pounds for pink
}
console.log(`Total amount of apples picked, in pounds: \n` 
+ `    Fuji: ${fujiPounds} \n    Gala: ${galaPounds} \n    Pink: ${pinkPounds}`); //prints each amount of pouns to console 
...
let fujiProfit = fujiPrice * fujiPounds; //calculates profit for fuji
let galaProfit = galaPrice * galaPounds; //calculates profit for gala
let pinkProfit = pinkPrice * pinkPounds; //calculates profit for pink

console.log(`Profit: \n` 
+ `    Fuji: ${fujiProfit} \n    Gala: ${galaProfit} \n    Pink: ${pinkProfit}`); //prints each profit to console
...
// CODE HERE
let totalProfit = fujiProfit + galaProfit + pinkProfit; //calculates total profit for all of 3 types 

console.log(`Total profit: ${totalProfit}`); //prints total profit to console